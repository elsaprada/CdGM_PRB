...
#region ## Column A
colname = "A"
model0 = (; base_model..., Vmin = -40, Vmax = -20, a0 = 5,
         Vmin_lead = -40, Vmax_lead = -20)
...
#plot(ldosA, "Output/FigSolidAppendix/FigSolid_$(colname)_ldos"; zfactor = 0.5)

## Cond short
model = model1
Lsys, iC, iL, ΓL, leadS = build_cyl(; model...);
condAs = conductance()
#plot(condAs, "Output/FigSolidAppendix/FigSolid_$(colname)_cond_short", labelbar = "dI/dV [G₀]", zfactor = 0.5)

## Cond long
model = model3
Lsys, iC, iL, ΓL, leadS = build_cyl(; model...);
condAl = conductance()
#plot(condAl, "Output/FigSolidAppendix/Test/FigSolid_$(colname)_cond_long", labelbar = "dI/dV [G₀]", zfactor = 0.5)

# ## Transparency
# mjs = 0
# gm = gamma()
# plot(gm, "Output/FigSolidAppendix/FigSolid_$(colname)_gamma"; zfactor = 0.9, xlabel = "τ")
...
#region ## Column B
colname = "B"
model0 = (; base_model..., Vmin = -70, Vmax = -20, a0 = 5,
         Vmin_lead = -70, Vmax_lead = -20)
...
# plot(ldosB, "Output/FigSolidAppendix/FigSolid_$(colname)_ldos"; zfactor = 0.5)

## Cond short
model = model1
Lsys, iC, iL, ΓL, leadS = build_cyl(; model...);
condBs = conductance()
# plot(condBs, "Output/FigSolidAppendix/FigSolid_$(colname)_cond_short", labelbar = "dI/dV [G₀]", zfactor = 0.4)

## Cond long
model = model3
Lsys, iC, iL, ΓL, leadS = build_cyl(; model...);
condBl = conductance()
# plot(condBl, "Output/FigSolidAppendix/FigSolid_$(colname)_cond_long", labelbar = "dI/dV [G₀]", zfactor = 0.5)
...
# Lsys, iC, iL, ΓL, leadS = build_cyl(; model...);
# condBs = conductance()
# plot(condBs, "Output/FigSolidAppendix/FigSolid_$(colname)_cond_short_extra", labelbar = "dI/dV [G₀]", zfactor = 0.4)

#endregion

#region ## Column C
colname = "C"
model0 = (; base_model..., Vmin = -140, Vmax = -20, a0 = 5,
         Vmin_lead = -140, Vmax_lead = -20)
...
# plot(ldosC, "Output/FigSolidAppendix/FigSolid_$(colname)_ldos"; zfactor = 0.5)

## Cond short
model = model1
Lsys, iC, iL, ΓL, leadS = build_cyl(; model...);
condCs = conductance()
# plot(condCs, "Output/FigSolidAppendix/FigSolid_$(colname)_cond_short", labelbar = "dI/dV [G₀]", zfactor = 0.5)

## Cond long
model = model3
Lsys, iC, iL, ΓL, leadS = build_cyl(; model...);
condCl = conductance()
# plot(condCl, "Output/FigSolidAppendix/FigSolid_$(colname)_cond_long", labelbar = "dI/dV [G₀]", zfactor = 0.5)
...
plot(ldosA, "Output/FigSolidAppendix/FigSolid_A_ldos"; zfactor = 0.5);
plot(condAs, "Output/FigSolidAppendix/FigSolid_A_cond_short", labelbar = "dI/dV [G₀]", zfactor = 0.5);
plot(condAl, "Output/FigSolidAppendix/FigSolid_A_cond_long", labelbar = "dI/dV [G₀]", zfactor = 0.5);

plot(ldosB, "Output/FigSolidAppendix/FigSolid_B_ldos"; zfactor = 0.5);
plot(condBs, "Output/FigSolidAppendix/FigSolid_B_cond_short", labelbar = "dI/dV [G₀]", zfactor = 0.5);
plot(condBl, "Output/FigSolidAppendix/FigSolid_B_cond_long", labelbar = "dI/dV [G₀]", zfactor = 0.5);

plot(ldosC, "Output/FigSolidAppendix/FigSolid_C_ldos"; zfactor = 0.5);
plot(condCs, "Output/FigSolidAppendix/FigSolid_C_cond_short", labelbar = "dI/dV [G₀]", zfactor = 0.5);
plot(condCl, "Output/FigSolidAppendix/FigSolid_C_cond_long", labelbar = "dI/dV [G₀]", zfactor = 0.5);
...
# ## Load and plot
# dict = load("Output/FigSolidAppendix/FigSolid_CZ_cond_long.jld2")
# xs, ys, zs = dict["xs"], dict["ys"], dict["mjdict"]
# params, model = dict["params"], dict["model"]
# plot_and_export(xs, ys, zs; filename =  "Output/FigSolidAppendix/FigSolid_CZ_cond_long", labelbar = "dI/dV [G₀]", zfactor = 0.2, xlabel = "Φ/Φ₀", pages = false, layers = false)