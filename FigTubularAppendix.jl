...
base_model = (;
    ξd = 0.001, Rshell = 70, Rcore = 70, Raxis = 0, a0 = 5,
    Δ0 = 0.23, α=0, g = 0, Vexponent = 2)

base_params = (; τΓ = 10)

ωrng = range(-0.26, 0.26, 300) .+ 0.001im
nrng = range(0, 3.499, 400)
...
# plot(dataB, "Output/FigTubularAppendix/FigTubularb"; zfactor = 0.7, zfactor´ = 0.9)
#endregion
...
# plot(dataC, "Output/FigTubularAppendix/FigTubularc"; zfactor = 0.7, zfactor´ = 0.6)
...
# plot(dataD, "Output/FigTubularAppendix/FigTubulard"; zfactor = 0.5, zfactor´ = 0.6)
...
# plot(dataE, "Output/FigTubularAppendix/FigTubulare"; zfactor = 0.5, zfactor´ = 0.6)
...
# plot(dataF, "Output/FigTubularAppendix/FigTubularf"; zfactor = 0.8, zfactor´ = 0.6)
...
# plot(dataG, "Output/FigTubularAppendix/FigTubularg"; zfactor = 0.8, zfactor´ = 0.6)
...
# plot(dataH, "Output/FigTubularAppendix/FigTubularh"; zfactor = 0.5, zfactor´ = 0.6)
...
# plot(dataI, "Output/FigTubularAppendix/FigTubulari"; zfactor = 0.5, zfactor´ = 0.6)
...
plot(dataB, "Output/FigTubularAppendix/FigTubularb"; zfactor = 0.5, zfactor´ = 0.6);
plot(dataC, "Output/FigTubularAppendix/FigTubularc"; zfactor = 0.5, zfactor´ = 0.6);
plot(dataD, "Output/FigTubularAppendix/FigTubulard"; zfactor = 0.5, zfactor´ = 0.6);
plot(dataE, "Output/FigTubularAppendix/FigTubulare"; zfactor = 0.5, zfactor´ = 0.6);
plot(dataF, "Output/FigTubularAppendix/FigTubularf"; zfactor = 0.5, zfactor´ = 0.6);
plot(dataG, "Output/FigTubularAppendix/FigTubularg"; zfactor = 0.5, zfactor´ = 0.6);
plot(dataH, "Output/FigTubularAppendix/FigTubularh"; zfactor = 0.5, zfactor´ = 0.6);
plot(dataI, "Output/FigTubularAppendix/FigTubulari"; zfactor = 0.5, zfactor´ = 0.6);
